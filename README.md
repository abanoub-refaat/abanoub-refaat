...
<p>
  <strong>Full-Stack Developer (Next.js | TypeScript | React Native) | AI & ML Enthusiast | CS Student @ Cairo University</strong><br><br>
  I'm a passionate developer with a strong foundation in both <strong>frontend and backend development</strong>, and a growing interest in <strong>Artificial Intelligence and Machine Learning</strong>.  
  I love building dynamic, user-centric web and mobile applications using modern technologies like <strong>Next.js, React Native, and Node.js</strong>, while continuously learning about deep learning and data-driven systems.  
  My background includes <strong>Algorithms, Data Structures, Database Systems, OOP, and System Design</strong>, backed by solid problem-solving and teamwork skills.
</p>

### 🧠 &nbsp;Current Focus
- Exploring the intersection of **AI & Software Development**  
- Building full-stack projects with **Next.js**, **TypeScript**, and **MongoDB**  
- Learning **Jetpack Compose** for Android development  
- Experimenting with **ML models and deep learning frameworks**  
...
![Scikit-learn](https://img.shields.io/badge/Scikit--learn-%231E1E1E.svg?style=for-the-badge&logo=scikit-learn&logoColor=%23F7931E)&nbsp;
...
<table style="border-radius: 10px; overflow: hidden; border-collapse: separate; border-spacing: 0;">
  <tr border="0">
    ...
    <td style="border: none; padding: 0;">
      <img height="200" src="https://personal-github-readme-stats-beta.vercel.app/api/top-langs/?username=abanoub-refaat&layout=compact&langs_count=25&theme=vision-friendly-dark&count_private=true&hide=HTML,CSS,M,Swift,CMake" style="border-radius: 10px;"/>
    </td>
  </tr>
</table>

<p align="center">
  <i>"Building for today, learning for tomorrow."</i>
</p>
